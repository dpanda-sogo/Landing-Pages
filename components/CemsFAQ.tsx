...
import { faqs } from "./cemsFaqData";

export default function CemsFAQ() {
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px,3vw,36px)", fontWeight: 700, lineHeight: 1.2, letterSpacing: "-0.02em" }}>
            Customer Experience Management Software — Frequently Asked Questions
          </h2>
        </div>
            ...
            <div key={faq.q} style={{ borderBottom: "1px solid var(--border)" }}>
              ...
              <AnimatePresence initial={false}>
                {open === i && (
                  ...
                  >
                    <p style={{ fontSize: 14, color: "var(--text-muted)", lineHeight: 1.7, paddingBottom: 18 }}>{faq.a}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
